...
**단품 평가 환경 자동화 플랫폼** — 차량용 제어기(BLTN) 검증 시 필요한, "녹화 · 전원제어 · CAN 신호연동 · AI 기반 T/C 스크립트 자동 생성" 등의 기능을 통합한 검증 플랫폼 프로그램.
...
[![YouTube](https://img.shields.io/badge/YouTube-Demo-red?logo=youtube)](https://youtu.be/LCkzGNMzZxA)    <-  클릭

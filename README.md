**업무 활성화용 단품 평가 환경 플랫폼 개발** (26.03.02 ~ 현재)
-
-
(참고)

-> 내부 / 외부(외부LLM포함) 통신 가능하게, 프로그램 내 AI 및 추가 기능들을 API로 활용하도록 반영 O
...
1. 기능 실행 및 설정값들을 함수화 및 파라메터화 하여, 어떻게 스크립트에서 활용할 수 있을지를 정리해놓은 도큐먼트
-
[녹화]
